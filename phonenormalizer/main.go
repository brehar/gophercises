...
func main() {
	psqlInfo := fmt.Sprintf("host=%s port=%d user=%s password=%s sslmode=disable", host, port, user, os.Getenv("MYSQL_ROOT_PASSWORD"))
...
func createPhoneNumbersTable(db *sql.DB) error {
	statement := "CREATE TABLE IF NOT EXISTS phone_numbers (id SERIAL, value VARCHAR(255))"
